 ...
 * 
 * @version 3
 * @author Philippe Brutus : The master of Java
 */
...
public class Date implements Comparable<Date> {
     ...
     * @param m un entier qui détermine le mois de l'année
     * @param a un entier qui détermine l'année
     * 
     * @exception ExceptionMauvaisJour exception indiquant si le jour est incorrect
    ...
    /**
     * Construit une date en donnant des valeurs aux variables d'instance de l'objet Date
     * @param texte une chaîne de caractère au format jj/mm/aaaa
     */
     ...
     * @return une chaîne de caractère au format jj/mm/aaaa
     */
     ...
     * @return un booléen (vrai ou faux) vrai si l'année a est bissextile, faux dans le cas contraire
     */
    ...
    /**
     * détermine le nombre de jour d'un mois de l'année
     * 
     ...
     */
    //Static méthode qui lie la méthode à la class
     ...
     * @param autreDate une instance(objet) de la classe Date à comparer
     * @return un entier nul si les deux dates sont égales,
     * un entier positif si la date considérée est postérieur que autreDate,
     * un entier négatif si la date considérée est antérieur à autreDate.
     * 
